...
![重边、自环的表示形式](/tree-and-graph/2.png)
...
![正常树](/tree-and-graph/3.png)\
这是树。

![形态难以分辨的树](/tree-and-graph/4.png)\
这也是刚刚的那棵树，只是换了个形态。

![非法的树](/tree-and-graph/5.png)\
